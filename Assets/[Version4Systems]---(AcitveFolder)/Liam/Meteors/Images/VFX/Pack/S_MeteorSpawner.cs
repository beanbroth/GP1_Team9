...
public class S_MeteorSpawner : MonoBehaviour
{
    ...
    [SerializeField]
    private float spawnInterval = 120.0f; // Editable time interval in seconds

    [SerializeField]
    private float xOffset = 12.0f; // Default X offset
    [SerializeField]
    private float yOffset = -18.2f; // Default Y offset
    ...
    [SerializeField]
    private float xSpeed = 20.0f; // Customizable X movement speed
    [SerializeField]
